// Copyright 2021 Maikel Poot, All rights reserved.
//
// This package contains another series of changes and additions to the the build-in
// log package from the Go Authors found here:
// https://golang.org/src/log/log.go
// and from the GoLogme author found here:
// https://github.com/gologme/log/blob/master/log.go
...
//
// Calldepth is used to recover the PC and is
...
func (l *Logger) Output(level string, s string) error {
	...
	// Allow the default standard log types to just work
	if level != "" {
...
func Output(calldepth int, s string) error {
	return std.Output("", s) // +1 for this frame.
}

// ----------------------------------------------------------------------
//
// My changes for level logging
//
// ----------------------------------------------------------------------

/*
SetCallDepth - This function will set the call depth. By default the call depth
